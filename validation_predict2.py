# -*- coding: utf-8 -*-
"""
Created on Tue Oct 23 21:25:01 2018
...
for i,params in enumerate(parameters):
    ...
    predict(n_simulations,horizon,val_input,model,model_name,\
                     '',val_output)
